    ...
    respond_to do |format|
      if params[:cancel].blank?
        if @comment.save
          ...
          @commontator_page = @commontator_thread.new_comment_page(@comment.parent_id, @commontator_show_all)

          if !@commontator_thread.commontable.user.nil? && @commontator_user != @commontator_thread.commontable.user && @comment.parent.nil?
            Notifications::CreateService.call(title: :comment_created, correctable: @commontator_thread.commontable)
          end

          if !@comment.parent.nil? && @comment.parent.creator.present? && @commontator_user != @comment.parent.creator
            Notifications::CreateService.call(title: :comment_answered, correctable: @commontator_thread.commontable,
                                              user: @comment.parent.creator)
          end
