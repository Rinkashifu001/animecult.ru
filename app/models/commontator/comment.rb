...
#  index_commontator_comments_on_editor_type_and_editor_id  (editor_type,editor_id)
#  index_commontator_comments_on_parent_id                  (parent_id)
#  index_commontator_comments_on_thread_id_and_created_at   (thread_id,created_at)
#
# Foreign Keys
#
#  fk_rails_...  (parent_id => commontator_comments.id) ON DELETE => cascade ON UPDATE => restrict
