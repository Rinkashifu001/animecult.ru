...
# Indexes
#
#  index_commontator_threads_on_c_id_and_c_type            (commontable_type,commontable_id) UNIQUE
#  index_commontator_threads_on_closer_type_and_closer_id  (closer_type,closer_id)
#
